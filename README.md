...
Le bloc parser + extraction est conçu pour devenir un **connecteur d'ingestion**
qui déverse des signaux (volumes, irritants, catégories) dans le graphe de contexte
de l'assistant de qualification d'opportunités IA (projet « Alfred ») : la
découverte métier nourrie sans entretien manuel.
